...
const courseDetails: { [key: string]: any } = {
  ...
  // We can add details for other courses here later
  "jee-mains": { name: "JEE MAINS", description: ["Detailed information about JEE Mains will be updated soon."] },
